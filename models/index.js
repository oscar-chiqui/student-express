...
let env = process.env.NODE_ENV || 'development' // set a default if no environment.//
...
let password = process.env.DB_PASSWORD // undefined locally,
// Set the DB_PASSWORD environment variable at Azure
